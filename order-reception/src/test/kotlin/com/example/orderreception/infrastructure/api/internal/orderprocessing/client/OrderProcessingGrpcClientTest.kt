    ...
    inner class NormalCase {
        ...
        fun 正常系() {
            ...
            targetServer.receivedOrderCreationRequest.let {
                assertThat(it.order.orderItemsList).hasSize(2)
                assertThat(it.order.orderItemsList[0].id).isEqualTo(1)
                assertThat(it.order.orderItemsList[0].price.units).isEqualTo(100)
                assertThat(it.order.orderItemsList[0].price.nanos).isEqualTo(0)
                assertThat(it.order.orderItemsList[0].price.currencyCode).isEqualTo("JPY")
                assertThat(it.order.orderItemsList[0].attributesList).hasSize(2)
                assertThat(it.order.orderItemsList[0].attributesList[0].id).isEqualTo(1)
                assertThat(it.order.orderItemsList[0].attributesList[0].name).isEqualTo(order.orderItems[0].attributes[0].name)
                assertThat(it.order.orderItemsList[0].attributesList[0].value).isEqualTo(order.orderItems[0].attributes[0].value)
                assertThat(it.order.orderItemsList[0].attributesList[1].id).isEqualTo(2)
                assertThat(it.order.orderItemsList[0].attributesList[1].name).isEqualTo(order.orderItems[0].attributes[1].name)
                assertThat(it.order.orderItemsList[0].attributesList[1].value).isEqualTo(order.orderItems[0].attributes[1].value)
                assertThat(it.order.orderItemsList[0].quantity).isEqualTo(1)
                assertThat(it.order.orderItemsList[1].id).isEqualTo(2)
                assertThat(it.order.orderItemsList[1].price.units).isEqualTo(200)
                assertThat(it.order.orderItemsList[1].price.nanos).isEqualTo(0)
                assertThat(it.order.orderItemsList[1].price.currencyCode).isEqualTo("JPY")
                assertThat(it.order.orderItemsList[1].attributesList).hasSize(2)
                assertThat(it.order.orderItemsList[1].attributesList[0].id).isEqualTo(3)
                assertThat(it.order.orderItemsList[1].attributesList[0].name).isEqualTo(order.orderItems[1].attributes[0].name)
                assertThat(it.order.orderItemsList[1].attributesList[0].value).isEqualTo(order.orderItems[1].attributes[0].value)
                assertThat(it.order.orderItemsList[1].attributesList[1].id).isEqualTo(4)
                assertThat(it.order.orderItemsList[1].attributesList[1].name).isEqualTo(order.orderItems[1].attributes[1].name)
                assertThat(it.order.orderItemsList[1].attributesList[1].value).isEqualTo(order.orderItems[1].attributes[1].value)
                assertThat(it.order.orderItemsList[1].quantity).isEqualTo(2)
                ...
                assertThat(it.order.payment.deliveryCharge.units).isEqualTo(350)
                assertThat(it.order.payment.deliveryCharge.currencyCode).isEqualTo("JPY")
                assertThat(it.order.payment.nonTaxedTotalPrice.units).isEqualTo(850)
                assertThat(it.order.payment.nonTaxedTotalPrice.currencyCode).isEqualTo("JPY")
                assertThat(it.order.payment.tax.units).isEqualTo(85)
                assertThat(it.order.payment.tax.currencyCode).isEqualTo("JPY")
                assertThat(it.order.payment.taxedTotalPrice.units).isEqualTo(935)
                assertThat(it.order.payment.taxedTotalPrice.currencyCode).isEqualTo("JPY")
