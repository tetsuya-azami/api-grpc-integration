...
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.createdAt
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.itemId
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.orderId
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.orderItemsBase
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.quantity
import com.example.orderprocessing.infrastructure.mapper.generated.OrderItemsBaseDynamicSqlSupport.updatedAt
...
@Mapper
interface OrderItemsBaseMapper : CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<OrderItemsBase>,
    CommonUpdateMapper {
    @SelectProvider(type = SqlProviderAdapter::class, method = "select")
    @Results(
        id = "OrderItemsBaseResult", value = [
...
fun OrderItemsBaseMapper.deleteByPrimaryKey(orderId_: String, itemId_: Long) =
    delete {
        where {
...
fun OrderItemsBaseMapper.selectByPrimaryKey(orderId_: String, itemId_: Long) =
    selectOne {
        where {
            orderId isEqualTo orderId_
            and { itemId isEqualTo itemId_ }
